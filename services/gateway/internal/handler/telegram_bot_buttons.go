...
func (h *TelegramBotHandler) buildPostStartText(ctx context.Context, userID, telegramID int64) string {
	...
	return fmt.Sprintf(
		"🔑 <b>Твой VPN-ключ</b>\n"+
			...
			"1. Скачай Happ — кнопки по платформам в Mini App "+
			"(нажми «🚀 Открыть приложение» сверху → раздел «Подключение»).\n"+
			"2. В Happ нажми <b>«+»</b> в правом верхнем углу → вставь "+
			"скопированную ссылку → <b>«Добавить»</b>.\n"+
			"3. Нажми большую кнопку включения → выбери сервер.\n\n"+
